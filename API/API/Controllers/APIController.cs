...
namespace mojePreduzece.Controllers
{
    ...
    public class APIController : Controller
    {
        static List<Preduzece> preduzeca = new List<Preduzece>()
            {
             new Preduzece { ime = "Dusan", prezime = "Nikolic", email = "dusannrt8619@gs.viser.edu.rs", naziv = "Naziv1", adresa = "Bulevar Oslobodjenja 221", PIB = 111100000 },
             new Preduzece { ime = "Marko", prezime = "Markic", email = "markicm@gmail.com", naziv = "Naziv2", adresa = "Niksicka 34", PIB = 111100001 },
             new Preduzece { ime = "Ivan", prezime = "Ivic", email = "ivicivan@gamil.com", naziv = "Naziv3", adresa = "Miroslava Zetskog 11a", PIB = 111100002 },
             new Preduzece { ime = "Petar", prezime = "Peric", email = "petarp@gamil.com", naziv = "Naziv4", adresa = "Kralja Filipa 17", PIB = 111100003 },
             new Preduzece { ime = "Milos", prezime = "Misic", email = "milosm@gamil.com", naziv = "Naziv5", adresa = "Nova 14", PIB = 111100004 }
           };
        static List<Faktura> fakture = new List<Faktura>()
            {
             new Faktura { id = 1 ,PIBkome = 111100000, PIBodKoga = 111100001, datumGenerisanja =  new DateTime(2022, 9, 14), datumPlacanja = new DateTime(2022, 9, 14), ukupnaCena = 500, tipFakture = "izlazna",naziv= "faktura" ,cenaPoJediniciMere= 100 ,jedinicaMere= "RSD",kolicina = 5},
             new Faktura { id = 1 ,PIBkome = 111100001, PIBodKoga = 111100000, datumGenerisanja =  new DateTime(2022, 9, 14), datumPlacanja = new DateTime(2022, 9, 14), ukupnaCena = 500, tipFakture = "ulazna",naziv= "faktura" ,cenaPoJediniciMere= 100 ,jedinicaMere= "RSD",kolicina = 5}
           };
        //ready
